//Original source code: https://github.com/jonhoo/rust-basic-hashmap
//youtube link: https://www.youtube.com/watch?v=k6xR2kf9hlA&t=1444s
...
where K: Hash + Eq,
{
	...
	pub fn entry<'a>(&'a mut self, key: K) -> Entry<'a, K, V> {
		...
		let bucket = self.bucket(&key).expect("buckets.is_empty() handled)");
